    ...
    <div className="min-h-screen flex flex-col bg-background page-enter">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-20 max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8 mt-16 sm:mt-24">
          <div className="text-center p-6 sm:p-8 rounded-3xl bg-card/30 backdrop-blur-sm border border-border/30 hover:border-primary/30 transition-all duration-300 hover:shadow-lg animate-fade-in-up card-hover" style={{ animationDelay: '0.2s' }}>
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">Lightning Fast</h3>
            <p className="text-muted-foreground leading-relaxed text-sm sm:text-base">Generate QR codes instantly with our optimized processing engine and cloud infrastructure.</p>
          </div>
          
          <div className="text-center p-6 sm:p-8 rounded-3xl bg-card/30 backdrop-blur-sm border border-border/30 hover:border-primary/30 transition-all duration-300 hover:shadow-lg animate-fade-in-up card-hover" style={{ animationDelay: '0.4s' }}>
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">Secure & Private</h3>
            <p className="text-muted-foreground leading-relaxed text-sm sm:text-base">Bank-level encryption with password protection and self-destruct options keep your files safe.</p>
          </div>
          
          <div className="text-center p-6 sm:p-8 rounded-3xl bg-card/30 backdrop-blur-sm border border-border/30 hover:border-primary/30 transition-all duration-300 hover:shadow-lg animate-fade-in-up card-hover" style={{ animationDelay: '0.6s' }}>
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">Fully Customizable</h3>
            <p className="text-muted-foreground leading-relaxed text-sm sm:text-base">Design your QR codes with custom frames, colors, logos, and professional styling options.</p>
          </div>
        </div>
      </main>
    </div>
